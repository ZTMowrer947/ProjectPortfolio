        ...
        <article className="portfolio-about mt-3">
            <Row>
                <Col xs={12} md={8}>
                    ...
                    <p>
                        Having been programming seriously since late 2016, I have developed into a lifelong learner with a burning passion
                        to write software that makes others happy. I am hard-working, honest person above all else, always looking for
                        something to learn or another challenge to overcome. A tinkerer and experimenter at heart, I am more than willing to
                        adapt to new technologies and to the needs of others.
                    </p>
                    <p>
